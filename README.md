...
See below for the commands to run the Dockerfile in various modes/versions(see code base for example as to how multi-stage build have been used to have a production and developer mode/version) 
